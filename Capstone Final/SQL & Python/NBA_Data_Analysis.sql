...
all_star_id Text Primary Key Not Null,
player_id Text,
player VARCHAR(100),
team VARCHAR(100),
season Text,
...
replaced VARCHAR(10),
all_star VARCHAR(5),
Foreign Key (player) References Player_Shooting(player)
)
...
And p.player = pt.player
Left Join All_Star_Selections ast
On p.player_id = ast.player_id
And p.player = ast.player;
